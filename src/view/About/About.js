...
class About extends React.Component {
 ...
 handleSubmit = e => {
  ...
  this.props.addNum(
   this.state.name,
   this.state.number,
   this.state.supercontact,
   this.state.cool,
   this.state.priorytet
  );
 };
    ...
    <form onSubmit={this.handleSubmit} className={style.form}>
     ...
     <label>
      ...
      <input
       name={"supercontact"}
       type="checkbox"
       checked={this.state.supercontact}
       onChange={this.changeInputs}
      />
     </label>
     <label>
     ...
     <section>
      ...
      <label>
       ...
       <input
        type="radio"
        checked={this.state.priorytet === "hight"}
        name="priorytet"
        value="hight"
        onChange={this.handleRadioPriotytyChange}
       />
      </label>
      <label>
       Medium
       <input
        type="radio"
        checked={this.state.priorytet === "medium"}
        name="priorytet"
        value="medium"
        onChange={this.handleRadioPriotytyChange}
       />
      ...
      <label>
       ...
       <input
        type="radio"
        checked={this.state.priorytet === "low"}
        name="priorytet"
        value="low"
        onChange={this.handleRadioPriotytyChange}
       />
