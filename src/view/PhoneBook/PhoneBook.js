      ...
      <div className={style.content}>
        ...
        <form>
          ...
          <label style={{ border: "1px solid", padding: "1px", marginRight: "2px" }}>
            Priority: less
            <input name="priority" type="radio" value="low" checked={priority === "low"} onChange={this.handleRadio} />
            <input name="priority" type="radio" value="medium" checked={priority === "medium"} onChange={this.handleRadio} />
            <input name="priority" type="radio" value="hight" checked={priority === "hight"} onChange={this.handleRadio} /> more
          </label>
          <label>
